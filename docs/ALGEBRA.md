...
| L2 | **Near-commutativity.** `translate(a) ∘ translate(b) ≈ translate(b) ∘ translate(a)`; the deviation from context-freeness of directions is the cross-talk Jacobian. | measured | hours 6/8: era×voice order gap 0.50 rank, gain-profile correlation 0.85; off-diagonal 0.06–0.20 vs diagonal 0.47–0.76 |
