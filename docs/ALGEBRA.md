...
| transform: translate (parameterized) | `Param × Scale → Op` | `scripts/time_translation{,_selector}.py` | hour 28 | measured as selector: shared clock direction, rank 3.88/9 vs 5.65 random for Δt ≥ 1 y; subject-relative timescale not found |
